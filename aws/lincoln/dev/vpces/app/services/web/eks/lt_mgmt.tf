...
resource "aws_launch_template" "mgmt" {
  ...
  name = "${var.project_name}-lt-${var.environment_name}-mgmt-node"
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-ec2-${var.environment_name}-mgmt-node"
    }
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-ebs-${var.environment_name}-mgmt-node"
    }
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-eni-${var.environment_name}-mgmt-node"
    }
  }
