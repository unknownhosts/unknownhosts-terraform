...
resource "aws_launch_template" "app" {
  ...
  name = "${var.project_name}-lt-${var.environment_name}-app-node"
  ...
  network_interfaces {
    ...
    security_groups             = [ module.eks.node_security_group_id,
                                    #module.eks.module.eks_managed_node_group.security_group_id
                                  ]
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-ec2-${var.environment_name}-app-node"
    }
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-ebs-${var.environment_name}-app-node"
    }
  }
  ...
  tag_specifications {
    ...
    tags = {
      Name = "${var.project_name}-eni-${var.environment_name}-app-node"
    }
  }
